...
-- 256 routes: 32 groups x 8 routes each (groups 0-15 repeated as 16-31)
type API
    -- group 0: users
    =    "users" :> Get '[JSON] [User]
    ...
    :<|> "users2" :> Capture "id" Int :> Get '[JSON] User
    :<|> "users2" :> ReqBody '[JSON] User :> Post '[JSON] User
    :<|> "users2" :> Capture "id" Int :> ReqBody '[JSON] User :> Put '[JSON] User
    :<|> "users2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "users2" :> Capture "id" Int :> "items" :> Get '[JSON] [User]
    :<|> "users2" :> Capture "id" Int :> "items" :> ReqBody '[JSON] User :> Post '[JSON] User
    :<|> "users2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [User]
    -- group 17: posts2
    :<|> "posts2" :> Get '[JSON] [BlogPost]
    :<|> "posts2" :> Capture "id" Int :> Get '[JSON] BlogPost
    :<|> "posts2" :> ReqBody '[JSON] BlogPost :> Post '[JSON] BlogPost
    :<|> "posts2" :> Capture "id" Int :> ReqBody '[JSON] BlogPost :> Put '[JSON] BlogPost
    :<|> "posts2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "posts2" :> Capture "id" Int :> "comments" :> Get '[JSON] [BlogPost]
    :<|> "posts2" :> Capture "id" Int :> "comments" :> ReqBody '[JSON] BlogPost :> Post '[JSON] BlogPost
    :<|> "posts2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [BlogPost]
    -- group 18: comments2
    :<|> "comments2" :> Get '[JSON] [Comment]
    :<|> "comments2" :> Capture "id" Int :> Get '[JSON] Comment
    :<|> "comments2" :> ReqBody '[JSON] Comment :> Post '[JSON] Comment
    :<|> "comments2" :> Capture "id" Int :> ReqBody '[JSON] Comment :> Put '[JSON] Comment
    :<|> "comments2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "comments2" :> Capture "id" Int :> "replies" :> Get '[JSON] [Comment]
    :<|> "comments2" :> Capture "id" Int :> "replies" :> ReqBody '[JSON] Comment :> Post '[JSON] Comment
    :<|> "comments2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Comment]
    -- group 19: tags2
    :<|> "tags2" :> Get '[JSON] [Tag]
    :<|> "tags2" :> Capture "id" Int :> Get '[JSON] Tag
    :<|> "tags2" :> ReqBody '[JSON] Tag :> Post '[JSON] Tag
    :<|> "tags2" :> Capture "id" Int :> ReqBody '[JSON] Tag :> Put '[JSON] Tag
    :<|> "tags2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "tags2" :> Capture "id" Int :> "children" :> Get '[JSON] [Tag]
    :<|> "tags2" :> Capture "id" Int :> "children" :> ReqBody '[JSON] Tag :> Post '[JSON] Tag
    :<|> "tags2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Tag]
    -- group 20: categories2
    :<|> "categories2" :> Get '[JSON] [Category]
    :<|> "categories2" :> Capture "id" Int :> Get '[JSON] Category
    :<|> "categories2" :> ReqBody '[JSON] Category :> Post '[JSON] Category
    :<|> "categories2" :> Capture "id" Int :> ReqBody '[JSON] Category :> Put '[JSON] Category
    :<|> "categories2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "categories2" :> Capture "id" Int :> "sub" :> Get '[JSON] [Category]
    :<|> "categories2" :> Capture "id" Int :> "sub" :> ReqBody '[JSON] Category :> Post '[JSON] Category
    :<|> "categories2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Category]
    -- group 21: products2
    :<|> "products2" :> Get '[JSON] [Product]
    :<|> "products2" :> Capture "id" Int :> Get '[JSON] Product
    :<|> "products2" :> ReqBody '[JSON] Product :> Post '[JSON] Product
    :<|> "products2" :> Capture "id" Int :> ReqBody '[JSON] Product :> Put '[JSON] Product
    :<|> "products2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "products2" :> Capture "id" Int :> "variants" :> Get '[JSON] [Product]
    :<|> "products2" :> Capture "id" Int :> "variants" :> ReqBody '[JSON] Product :> Post '[JSON] Product
    :<|> "products2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Product]
    -- group 22: orders2
    :<|> "orders2" :> Get '[JSON] [Order]
    :<|> "orders2" :> Capture "id" Int :> Get '[JSON] Order
    :<|> "orders2" :> ReqBody '[JSON] Order :> Post '[JSON] Order
    :<|> "orders2" :> Capture "id" Int :> ReqBody '[JSON] Order :> Put '[JSON] Order
    :<|> "orders2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "orders2" :> Capture "id" Int :> "items" :> Get '[JSON] [Order]
    :<|> "orders2" :> Capture "id" Int :> "items" :> ReqBody '[JSON] Order :> Post '[JSON] Order
    :<|> "orders2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Order]
    -- group 23: reviews2
    :<|> "reviews2" :> Get '[JSON] [Review]
    :<|> "reviews2" :> Capture "id" Int :> Get '[JSON] Review
    :<|> "reviews2" :> ReqBody '[JSON] Review :> Post '[JSON] Review
    :<|> "reviews2" :> Capture "id" Int :> ReqBody '[JSON] Review :> Put '[JSON] Review
    :<|> "reviews2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "reviews2" :> Capture "id" Int :> "responses" :> Get '[JSON] [Review]
    :<|> "reviews2" :> Capture "id" Int :> "responses" :> ReqBody '[JSON] Review :> Post '[JSON] Review
    :<|> "reviews2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Review]
    -- group 24: articles2
    :<|> "articles2" :> Get '[JSON] [Article]
    :<|> "articles2" :> Capture "id" Int :> Get '[JSON] Article
    :<|> "articles2" :> ReqBody '[JSON] Article :> Post '[JSON] Article
    :<|> "articles2" :> Capture "id" Int :> ReqBody '[JSON] Article :> Put '[JSON] Article
    :<|> "articles2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "articles2" :> Capture "id" Int :> "sections" :> Get '[JSON] [Article]
    :<|> "articles2" :> Capture "id" Int :> "sections" :> ReqBody '[JSON] Article :> Post '[JSON] Article
    :<|> "articles2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Article]
    -- group 25: albums2
    :<|> "albums2" :> Get '[JSON] [Album]
    :<|> "albums2" :> Capture "id" Int :> Get '[JSON] Album
    :<|> "albums2" :> ReqBody '[JSON] Album :> Post '[JSON] Album
    :<|> "albums2" :> Capture "id" Int :> ReqBody '[JSON] Album :> Put '[JSON] Album
    :<|> "albums2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "albums2" :> Capture "id" Int :> "tracks" :> Get '[JSON] [Album]
    :<|> "albums2" :> Capture "id" Int :> "tracks" :> ReqBody '[JSON] Album :> Post '[JSON] Album
    :<|> "albums2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Album]
    -- group 26: tracks2
    :<|> "tracks2" :> Get '[JSON] [Track]
    :<|> "tracks2" :> Capture "id" Int :> Get '[JSON] Track
    :<|> "tracks2" :> ReqBody '[JSON] Track :> Post '[JSON] Track
    :<|> "tracks2" :> Capture "id" Int :> ReqBody '[JSON] Track :> Put '[JSON] Track
    :<|> "tracks2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "tracks2" :> Capture "id" Int :> "lyrics" :> Get '[JSON] [Track]
    :<|> "tracks2" :> Capture "id" Int :> "lyrics" :> ReqBody '[JSON] Track :> Post '[JSON] Track
    :<|> "tracks2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Track]
    -- group 27: playlists2
    :<|> "playlists2" :> Get '[JSON] [Playlist]
    :<|> "playlists2" :> Capture "id" Int :> Get '[JSON] Playlist
    :<|> "playlists2" :> ReqBody '[JSON] Playlist :> Post '[JSON] Playlist
    :<|> "playlists2" :> Capture "id" Int :> ReqBody '[JSON] Playlist :> Put '[JSON] Playlist
    :<|> "playlists2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "playlists2" :> Capture "id" Int :> "tracks" :> Get '[JSON] [Playlist]
    :<|> "playlists2" :> Capture "id" Int :> "tracks" :> ReqBody '[JSON] Playlist :> Post '[JSON] Playlist
    :<|> "playlists2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Playlist]
    -- group 28: events2
    :<|> "events2" :> Get '[JSON] [Event]
    :<|> "events2" :> Capture "id" Int :> Get '[JSON] Event
    :<|> "events2" :> ReqBody '[JSON] Event :> Post '[JSON] Event
    :<|> "events2" :> Capture "id" Int :> ReqBody '[JSON] Event :> Put '[JSON] Event
    :<|> "events2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "events2" :> Capture "id" Int :> "attendees" :> Get '[JSON] [Event]
    :<|> "events2" :> Capture "id" Int :> "attendees" :> ReqBody '[JSON] Event :> Post '[JSON] Event
    :<|> "events2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Event]
    -- group 29: venues2
    :<|> "venues2" :> Get '[JSON] [Venue]
    :<|> "venues2" :> Capture "id" Int :> Get '[JSON] Venue
    :<|> "venues2" :> ReqBody '[JSON] Venue :> Post '[JSON] Venue
    :<|> "venues2" :> Capture "id" Int :> ReqBody '[JSON] Venue :> Put '[JSON] Venue
    :<|> "venues2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "venues2" :> Capture "id" Int :> "events" :> Get '[JSON] [Venue]
    :<|> "venues2" :> Capture "id" Int :> "events" :> ReqBody '[JSON] Venue :> Post '[JSON] Venue
    :<|> "venues2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Venue]
    -- group 30: artists2
    :<|> "artists2" :> Get '[JSON] [Artist]
    :<|> "artists2" :> Capture "id" Int :> Get '[JSON] Artist
    :<|> "artists2" :> ReqBody '[JSON] Artist :> Post '[JSON] Artist
    :<|> "artists2" :> Capture "id" Int :> ReqBody '[JSON] Artist :> Put '[JSON] Artist
    :<|> "artists2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "artists2" :> Capture "id" Int :> "albums" :> Get '[JSON] [Artist]
    :<|> "artists2" :> Capture "id" Int :> "albums" :> ReqBody '[JSON] Artist :> Post '[JSON] Artist
    :<|> "artists2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Artist]
    -- group 31: genres2
    :<|> "genres2" :> Get '[JSON] [Genre]
    :<|> "genres2" :> Capture "id" Int :> Get '[JSON] Genre
    :<|> "genres2" :> ReqBody '[JSON] Genre :> Post '[JSON] Genre
    :<|> "genres2" :> Capture "id" Int :> ReqBody '[JSON] Genre :> Put '[JSON] Genre
    :<|> "genres2" :> Capture "id" Int :> Delete '[JSON] NoContent
    :<|> "genres2" :> Capture "id" Int :> "artists" :> Get '[JSON] [Genre]
    :<|> "genres2" :> Capture "id" Int :> "artists" :> ReqBody '[JSON] Genre :> Post '[JSON] Genre
    :<|> "genres2" :> "search" :> QueryParam "q" Text :> Get '[JSON] [Genre]
